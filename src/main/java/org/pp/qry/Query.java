...
public class Query {
    ...
    // Constructor
	private Query() {}
	public Query(String qryStr) { this(); this.sql = qryStr; params = new ArrayList<>(); }
	// compile the query
	...
	public Query setParam(Object val) {
		Node nd = Node.objToNode(val);
		params.add(nd);
		return this;
	}
	// Filter map now
	public List<Map<String, Object>> filter(List<Map<String,Object>> l) {
		Node tmp = null; 	
		...
		System.out.println("Time: " + TimeUnit.NANOSECONDS.toMicros(System.nanoTime() - t));
		return retList;
	}
	// 
	public static List<Map<String, Object>> filterList(List<Map<String, Object>> list, String qry, Object...parms) {
		Query query = new Query(qry);
		// populate parameters first
		for (Object prm : parms)
		   query.setParam(prm);
		// compile query
		query.compile();
		// execute and return the result
		return query.filter(list);
	}
	// Test code
